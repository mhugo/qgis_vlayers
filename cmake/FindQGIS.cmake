...
##
## Tim Sutton
## QGIS_APP_DIR          = where to find system plugins
...
IF (QGIS_INCLUDE_DIR AND QGIS_CORE_LIBRARY AND QGIS_GUI_LIBRARY AND QGIS_ANALYSIS_LIBRARY AND QGIS_APP_DIR)
   SET(QGIS_FOUND TRUE)
ENDIF ()
...
IF (QGIS_FOUND)
   IF (NOT QGIS_FIND_QUIETLY)
     ...
     MESSAGE(STATUS "Found QGIS app directory: ${QGIS_APP_DIR}")
